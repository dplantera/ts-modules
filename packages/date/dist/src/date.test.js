...
describe("date", () => {
    ...
    test("last day of month", () => {
        const a = date();
        const last = dates_1.UtcDate.lastDayOfMonth(a);
    ...
    test("print date in berlin", () => {
        ...
        const print = a.toLocaleTimeString(dates_1.Locals.de(), { timeZone: dates_1.TZ.berlin, ...(0, dates_1.Format)() });
        const iso = new Intl.DateTimeFormat("DE", { timeZone: dates_1.TZ.berlin, ...(0, dates_1.Format)() });
    ...
    describe("IsoDateTime", () => {
        test("change time", () => {
            const a = date();
            const isoDT = dates_1.IsoDateTime.of(a);
